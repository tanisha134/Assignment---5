...
• Opened by ${issue.author} ${issue.createdAt?.slice(0,10)}
</span>
...
class="btn bg-blue-600 text-white"> Close</button>
...
<div onclick="openModal(${issue.id})"
class="card bg-base-100 shadow-lg hover:shadow-2xl transition border-t-4 ${borderColor} cursor-pointer">
